...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = "Image Worker") {
    ...
    const data: CanvasExportFile = { app: "imge-worker", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
